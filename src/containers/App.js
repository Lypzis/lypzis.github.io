              ...
              <li className="popup__list-item">
                <div className="popup__box">
                  ...
                  <div className="popup__box-description">
                    <p className="text">
                      This page, I've put all my effort into design it, using
                      most of what I've learned so far. Have you found the
                      hidden easter eggs?
                    </p>
                    <div className="popup__box-link">
                      <a
                        ...
                        href="https://github.com/Lypzis/Lypzis.github.io/tree/development"
            ...
            <ol className="popup__list">
              <li className="popup__list-item">
                <div className="popup__box">
                  ...
                  <div className="popup__box-description">
                    <p className="text">
                      A gamified business world, it's currently in prototype
                      version.
                    </p>
                    <div className="popup__box-link">
                      <a
                        target="_blank"
                        href="https://evoloot.github.io/evolootApp/"
                        rel="noopener noreferrer"
                        className="btn button__link"
                      >
            ...
            <ol className="popup__list">
              <li className="popup__list-item">
                <div className="popup__box">
                  ...
                  <div className="popup__box-description">
                    <p className="text">
                      Many of my projects that are experimental, old, can't
                      display or did not have time to finish are all safe on my
                      repositories waiting for resurrection or purpose. They
                      will be on the hightlights again one day.
                    </p>
                    <div className="popup__box-link">
                      <a
                        target="_blank"
                        href="https://github.com/Lypzis"
                        rel="noopener noreferrer"
                        className="btn button__link"
                      >
                        On GitHub
              ...
              <div className="popup__box-description">
                ...
                <div className="popup__box-link">
                  <a
                    target="_blank"
                    rel="noopener noreferrer"
                    href="https://lypzis.github.io/redux-react/"
                    className="btn button__link"
                  >
                    view page <span>&rarr;</span>
                  </a>
                  <a
                    target="_blank"
                    rel="noopener noreferrer"
                    href="https://github.com/Lypzis/redux-react"
                    className="btn button__link"
                  >
                    source code <span>&rarr;</span>
                  </a>
